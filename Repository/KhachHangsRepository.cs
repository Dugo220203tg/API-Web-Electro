...
namespace API_Web_Shop_Electronic_TD.Repository
{
	...
	public class KhachHangsRepository : IKhachHangRepository
	{
		...
		public async Task<KhachHang?> UpdatePasswordAsync(string currentPassword, string newPassword, string email)
		{
			...
			if (!VerifyPassword(currentPassword, khachHang.MatKhau, khachHang.RandomKey))
			{
				return null;
			}
